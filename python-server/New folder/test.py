...
# Gestión de dispositivos disponibles
available_devices = [1, 2]  # Lista de IDs de dispositivos disponibles
...
sock.listen(5)  # Permitir hasta 5 conexiones en espera
...
def process_critical_message(device_id, message):
...
def process_non_critical_message(device_id, message):
    global last_steering_value  # Declarar la variable como global
